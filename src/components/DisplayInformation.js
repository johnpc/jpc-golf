  ...
  return (
    <div style={{padding: "1vw"}}>
      ...
      <ul>
        ...
        <li>
          League price is $106 for 8 weeks of play. Cost includes $13 green fee.
          An additional $7 cart fee may be paid if you'd like to use a cart.
        </li>
        <li>
        ...
        <li>8 weeks beginning week of June 7</li>
        ...
        <li>Handicaps will be calculated after the first two weeks of play</li>
        <li>
        ...
        <li>
          The maximum score on any hole is double par. If you reach double par,
          just pick up your ball, shake it off, move on, and report your score
          as double par for the hole.
        </li>
        <li>
        ...
        <li>
          Contact me at john@johncorser.com or text me at 989-598-7705. Note: I
          have my phone set up to automatically silence unknown callers, so
